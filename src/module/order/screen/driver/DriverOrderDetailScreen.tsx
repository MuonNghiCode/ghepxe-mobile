...
export default function DriverOrderDetailScreen() {
  ...
  // Thêm state cho expanded customers
  ...
  // Function để toggle expand customer
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-white`}>
      ...
      <OrderMap
        ...
        orderType={order.type} // Đảm bảo pass đúng orderType
      />
      ...
      >
        ...
        <View style={tw`bg-white px-4 py-4 mb-4 border-b border-gray-200`}>
          ...
          <Text style={tw`text-xs text-gray-500 mb-2`}>
            ...
            {distance || "Đang tính..."} • {duration || "Đang tính..."}
          </Text>
          ...
          {order.customers.map((customer, customerIndex) => (
            <View key={customer.id} style={tw`mb-4`}>
              ...
              >
                ...
                {/* Chevron - hiển thị cho cả đơn lẻ và đơn ghép */}
                <TouchableOpacity>
                  <Ionicons
                    name={
              ...
              {expandedCustomers[customer.id] && (
                <View style={tw`ml-11`}>
                  ...
                  >
                    ...
                    <Text
                      style={tw`ml-auto text-sm text-[#00A982] font-semibold`}
                    >
                      {customer.price}
                    </Text>
                    <TouchableOpacity style={tw`ml-2`}>
