...
export default function UserHomeScreen() {
  ...
  const renderLocationSection = () => (
    <View style={[tw`-mt-15 mb-4 bg-white rounded-2xl p-3`, shadowStyle]}>
      <TouchableOpacity
      ...
      >
        ...
        />
        <Text style={tw`flex-1 text-base font-medium text-gray-600 ml-5`}>
          {deliveryLocation}
        </Text>
      </TouchableOpacity>
    </View>
          ...
          <TouchableOpacity
            ...
            style={[
              tw`h-1 rounded-full mr-1`,
              {
                ...
                backgroundColor: currentIndex === index ? "#00A982" : "#D1D5DB",
              },
            ]}
          />
        ))}
